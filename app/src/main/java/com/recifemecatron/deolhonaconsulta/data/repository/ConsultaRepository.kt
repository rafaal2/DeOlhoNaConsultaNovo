...
import com.recifemecatron.deolhonaconsulta.data.Api.response.ConsultaResponse
...
class ConsultaRepository(private val httpClient: HttpClient) {
    ...
    suspend fun consulta(codSolicitacao: String, tokenFirebase: String, tokenAplicacao: String): ConsultaResponse {
        return httpClient.post("http://10.0.2.2/jaboataoAPI/src/Api/solicitacao.php?acao=status") {
